...
Version  : 5.12.4
Release  : 17
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qttranslations-everywhere-src-5.12.4.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.4/submodules/qttranslations-everywhere-src-5.12.4.tar.xz
...
%prep
%setup -q -n qttranslations-everywhere-src-5.12.4
...
%install
export SOURCE_DATE_EPOCH=1561179838
rm -rf %{buildroot}
