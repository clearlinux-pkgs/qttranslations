...
Version  : 5.12.3
Release  : 16
URL      : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qttranslations-everywhere-src-5.12.3.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.3/submodules/qttranslations-everywhere-src-5.12.3.tar.xz
...
%prep
%setup -q -n qttranslations-everywhere-src-5.12.3
...
%install
export SOURCE_DATE_EPOCH=1556929474
rm -rf %{buildroot}
