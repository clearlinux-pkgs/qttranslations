...
Version  : 5.14.2
Release  : 22
URL      : https://download.qt.io/official_releases/qt/5.14/5.14.2/submodules/qttranslations-everywhere-src-5.14.2.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.14/5.14.2/submodules/qttranslations-everywhere-src-5.14.2.tar.xz
...
%prep
%setup -q -n qttranslations-everywhere-src-5.14.2
cd %{_builddir}/qttranslations-everywhere-src-5.14.2
...
%install
export SOURCE_DATE_EPOCH=1586210846
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qttranslations
cp %{_builddir}/qttranslations-everywhere-src-5.14.2/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qttranslations/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
%make_install
