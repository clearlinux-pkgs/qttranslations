...
Source0  : https://download.qt.io/official_releases/qt/5.12/5.12.1/submodules/qttranslations-everywhere-src-5.12.1.tar.xz
...
%prep
%setup -q -n qttranslations-everywhere-src-5.12.1
...
%install
export SOURCE_DATE_EPOCH=1549046759
rm -rf %{buildroot}
