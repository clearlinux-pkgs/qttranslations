...
Version  : 5.14.0
Release  : 20
URL      : https://download.qt.io/official_releases/qt/5.14/5.14.0/submodules/qttranslations-everywhere-src-5.14.0.tar.xz
Source0  : https://download.qt.io/official_releases/qt/5.14/5.14.0/submodules/qttranslations-everywhere-src-5.14.0.tar.xz
...
%prep
%setup -q -n qttranslations-everywhere-src-5.14.0
cd %{_builddir}/qttranslations-everywhere-src-5.14.0
...
%install
export SOURCE_DATE_EPOCH=1576221827
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/qttranslations
cp %{_builddir}/qttranslations-everywhere-src-5.14.0/LICENSE.GPL3-EXCEPT %{buildroot}/usr/share/package-licenses/qttranslations/e93757aefa405f2c9a8a55e780ae9c39542dfc3a
%make_install
